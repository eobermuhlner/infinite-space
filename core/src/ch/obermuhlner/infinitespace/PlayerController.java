...
public class PlayerController extends InputAdapter {
	...
	public PlayerController (Player player) {
		...
		boolean rollInvert = GamePreferences.INSTANCE.preferences.getBoolean(GamePreferences.BOOL_ROLL_INVERT);
		if (rollInvert) {
			rollLeft = ROLL_RIGHT;
			rollRight = ROLL_LEFT;
		}
		
		boolean pitchInvert = GamePreferences.INSTANCE.preferences.getBoolean(GamePreferences.BOOL_PITCH_INVERT);
		if (pitchInvert) {
			pitchUp = PITCH_DOWN;
			pitchDown = PITCH_UP;
		}
